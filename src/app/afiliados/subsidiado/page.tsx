...
export default function SubsidiadoPage() {
  const infoCards = [
    ...
    { title: "Consulta de IPS", description: "Validación de Derechos y Estado de Afiliación", link: "/afiliados/subsidiado/consulta-ips", iconUrl: "/images/img-sub/ico-directorio-oficinas.svg" },
