  ...
  return (
    <div className="p-6">
      <header className="mb-8 text-center">
        <h2 className="text-3xl font-bold">Bienvenido al Portal del Régimen Subsidiado</h2>
        <p className="mt-2 text-muted-foreground max-w-3xl mx-auto">
          Tu salud y bienestar son nuestra prioridad. Aquí encontrarás toda la información y herramientas que necesitas para gestionar tus servicios de salud.
        </p>
      </header>
