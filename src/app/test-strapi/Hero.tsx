...
export type HeroProps = {
  ...
  description?: string;
  image?: {
    url: string; // URL absoluta de Strapi
    alt?: string;
    formats?: {
...
export function Hero(props: HeroProps) {
  ...
  // Selección inteligente de la imagen: medium > large > original > placeholder
  const heroImage = image
    ? {
        src: image.formats?.medium?.url || image.formats?.large?.url || image.url,
